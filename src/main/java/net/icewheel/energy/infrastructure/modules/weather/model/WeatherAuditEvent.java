...
public class WeatherAuditEvent {
    ...
    @Column(nullable = false)
    @Check(constraints = "event_type IN ('FORECAST_FETCH_SUCCESS', 'FORECAST_FETCH_FAILURE', 'EVALUATION_GOOD_WEATHER', 'EVALUATION_BAD_WEATHER', 'FORCED_CHARGE_INITIATED', 'FORCED_CHARGE_SKIPPED', 'EVALUATION_FAILURE', 'EVALUATION_SUCCESS')")
